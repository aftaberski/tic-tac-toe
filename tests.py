...
class TestGame(TestCase):
    ...
    def test_is_winner(self):
        ...
        self.game.board.game_board = [["X", "O", ""],
                                    ["O", "X", ""],
                                    ["", "", "X"]]
        self.assertEqual(True, self.game.is_winner())
        ...
        self.game.board.game_board = [["O", "X", "O"],
                                    ["O", "O", "X"],
                                    ["", "X", "X"]]
        self.assertEqual(False, self.game.is_winner())

    def test_is_finished(self):
        self.game.board.game_board = [["X", "O", ""],
                                      ["O", "X", ""],
                                      ["", "O", ""]]
        self.assertEqual(False, self.game.is_finished())

        self.game.board.game_board = [["X", "O", "O"],
                                      ["O", "X", "X"],
                                      ["O", "O", "O"]]
        self.assertEqual(True, self.game.is_finished())
